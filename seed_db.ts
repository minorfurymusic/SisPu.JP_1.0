import fs from "fs";
import { saveAllStateToPostgres } from "./src/db/postgres.ts";
...
const initialData = {
  ...
  lancamentos: [
    {
      ...
      mes_ano_legado: "04/2026",
      criado_em: "2026-04-15T16:00:00Z",
      atualizado_em: "2026-04-15T16:00:00Z"
    },
    {
      id: "2",
      item_despesa_id: "1",
      ...
      criado_em: "2026-05-14T15:30:00Z",
      atualizado_em: "2026-05-14T15:30:00Z"
    },
    {
      id: "3",
      item_despesa_id: "2",
  ...
  pessoas: [
    { id: "1", codigo_legado: 501, nome: "CELESC DISTRIBUIÇÃO S.A.", tipo_pessoa: "JURIDICA", cpf_cnpj: "08.336.783/0001-90", telefone_comercial: "(48) 3231-5000", criado_em: "2026-01-10T10:00:00Z", atualizado_em: "2026-01-10T10:00:00Z" },
    { id: "2", codigo_legado: 502, nome: "CASAN COMPANHIA CATARINENSE DE AGUAS E SANEAMENTO", tipo_pessoa: "JURIDICA", cpf_cnpj: "82.508.433/0001-17", telefone_comercial: "(48) 3221-5000", criado_em: "2026-01-10T10:01:00Z", atualizado_em: "2026-01-10T10:01:00Z" }
  ],
  contatos_email: [
...
async function runSeed() {
  ...
  await saveAllStateToPostgres(initialData as any);
  console.log("SUCCESSFULLY_SEEDED");
  process.exit(0);
}
