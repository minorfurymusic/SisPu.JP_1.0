    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-200 flex flex-col font-sans" id="sispu-app-root">
      ...
      <header className="bg-[#0f0f0f] border-b border-white/10 py-3.5 px-6 sticky top-0 z-50 shadow-md">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            {/* Database Connection Badge / Button */}
            <button
              onClick={() => setIsModalOpen(true)}
              className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-mono font-medium transition border ${
                dbStatus.connected
            ...
            >
              ...
              <span>
                {dbStatus.connected ? "PostgreSQL Neon: Conectado" : "PostgreSQL: Configurar Conexão"}
              </span>
              {dbStatus.connected ? (
